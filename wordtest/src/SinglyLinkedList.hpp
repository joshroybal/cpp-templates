...
// template class 
template<class Type> 
struct SinglyLinkedList<Type>::Node
{  
   Type item;
   Node* next;
...
template<class Type> 
void SinglyLinkedList<Type>::Remove(const Type& item)
{
...
template<class Type> 
void SinglyLinkedList<Type>::Print() const
{
   print(head);
}

template<class Type> 
void SinglyLinkedList<Type>::Serialize(const std::string& filename) const
{
   std::ofstream ofstr;
...
template<class Type> 
void SinglyLinkedList<Type>::Deserialize(const std::string& filename)
{
   std::ifstream ifstr;
...
template<class Type> 
typename SinglyLinkedList<Type>::Node* SinglyLinkedList<Type>::insert(Node* p, const Type& x)
{
...
template<class Type> 
typename SinglyLinkedList<Type>::Node* SinglyLinkedList<Type>::remove(Node* p, const Type& x)
{
   if ( !p ) return p;
...
template<class Type>
typename SinglyLinkedList<Type>::Node* SinglyLinkedList<Type>::locate(Node* p, const Type& target) const
{
...
template<class Type> 
typename SinglyLinkedList<Type>::Node* SinglyLinkedList<Type>::reverse(Node* p)
{
   if (p == 0) return 0;
...
template<class Type> 
void SinglyLinkedList<Type>::print(Node* p) const
{
   if ( !p ) return;
...
template<class Type> 
void SinglyLinkedList<Type>::serialize(std::ofstream& ofstr, Node* p) const
{
   if (p == 0) return;
...
template<class Type> 
typename SinglyLinkedList<Type>::Node* SinglyLinkedList<Type>::deserialize(std::ifstream& ifstr)
{
   std::string tmp;
   if ( ifstr >> tmp ) {
...
template<class Type> 
void SinglyLinkedList<Type>::destroy(Node* p)
{
   if ( !p ) return;
   destroy(p->next);
   delete p;
